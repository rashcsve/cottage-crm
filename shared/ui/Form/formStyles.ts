export const formInputClass = (hasError: boolean): string => {
  const baseStyles =
    "min-h-11 w-full rounded-xl border px-3.5 py-2.5 text-base leading-6 outline-none transition placeholder:text-stone-400 disabled:cursor-not-allowed disabled:bg-stone-100 disabled:text-stone-500 sm:text-[15px]";
